...
### OUTPUT
<img width="803" height="190" alt="image" src="https://github.com/user-attachments/assets/fa06999e-86fa-4a4c-8ac4-ba1add0fae39" />

### Result:
Thus the program to get the name, age, and ID of a person and display them using multilevel inheritance has been implemented and executed successfully.ESULT
